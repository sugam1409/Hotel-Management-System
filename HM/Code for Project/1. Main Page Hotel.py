...
class HotelManagementSystem:
    ...
    # ---------- 1st image -----------------
        img1=Image.open(r"D:\project\HM\Hotel 1.jpg")
    ...
    # ----------- MENU ----------------
        lbl_menu=Label(main_frame,text="MENU",font=("times new roman",20,"bold"),bg="black",fg="#ff0000",bd=4,relief=RIDGE)
 ...
 # -----------button Frame-------------
    ...
    # ----------Right side image------------
        img3=Image.open(r"D:\project\HM\main frame image.jpg")
        # img3=Image.open(r"D:\project\HM\showpropertyGalleryimage.png")
    ...
    # -------------Down images-----------------
        img4=Image.open(r"D:\project\HM\building.jpg")
        ...
        img5=Image.open(r"D:\project\HM\food.jpg")
